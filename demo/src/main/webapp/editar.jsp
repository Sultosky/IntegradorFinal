			...
			<div class="container">
				<section>
					...
					<form method="POST"
						...
						<div class="mb-3">
							<label for="exampleFormControlInput1" class="form-label">Fabricacion</label>
							<input name="fabricacion"
								value="<%=producto.getFabricacion()%>"  
								type="text" class="form-control" id="exampleFormControlInput1" placeholder="Fabricacion" maxlength="50">
						  </div>
