			...
			<div class="container">
				<section>
					...
					<form method="post"
						...
						<div class="mb-3">
							<label for="exampleFormControlTextarea1" class="form-label">Fabricacion</label>
							<input name="fabricacion" type="text" class="form-control" id="exampleFormControlTextarea1" maxlength="7">
						</div>
